...
#SBATCH --gpus=1
#SBATCH --output=outputs/normalisation-test-%j.out
#SBATCH --mem=12GB
...
#head -n 10 data/dev.trg > data/dev.10.trg norm'env

#source activate /home/users/s/solfrini/.conda/envs/norm-env
